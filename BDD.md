...
> BDD conecta a linguagem de negócio ao processo de desenvolvimento, descrevendo funcionalidades do sistema a partir do comportamento esperado. 
> Assim, todos os envolvidos, técnicos ou não, compreendem o que será desenvolvido e validado.


## O que é?
Técnica de desenvolvimento de software criada por **Dan North**, como uma evolução do TDD.
Sua principal proposta é alinhar o código com os comportamentos esperados da aplicação, descritos em uma linguagem acessível para todos os envolvidos.
